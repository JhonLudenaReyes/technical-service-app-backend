...
namespace TechnicalService.Controllers
{
    ...
    public class GendersController : ControllerBase
    {
        ...
        // GET: api/Genders
        [HttpGet("/genders/list-active-genders")]
        public async Task<ActionResult<IEnumerable<Gender>>> GetActiveGenders()
        {
            if (_context.Genders == null)
            {
                return NotFound();
            }
            return await _context.Genders.Where(g => g.State.Equals("A")).ToListAsync();
        }
